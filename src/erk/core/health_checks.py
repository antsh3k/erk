...
def check_legacy_config_locations(repo_root: Path, metadata_dir: Path | None) -> CheckResult:
...
def run_all_checks(ctx: ErkContext) -> list[CheckResult]:
    ...
    if git_dir is not None:
        ...
        results.append(check_legacy_config_locations(repo_root, metadata_dir))
